...
{% include figure.html src="/img/unabomber-critique.svg" label="Fig. 1 · Separating the Diagnosis from the Cure" caption="Kaczynski identified real problems with industrial society. His proposed solution was evil and must be rejected." alt="Diagram showing valid critiques on the left and rejected violent cure on the right" %}
...
Taken together, this is a coherent critique of modernity. It is also not original to Kaczynski. Similar arguments appear in [Jacques Ellul](https://en.wikipedia.org/wiki/Jacques_Ellul), [Lewis Mumford](https://en.wikipedia.org/wiki/Lewis_Mumford), and the [Luddite](https://en.wikipedia.org/wiki/Luddite) tradition. The problem is not that he noticed these things. The problem is what he concluded.
