...
{% include figure.html src="/img/tesla-predictions.svg" label="Fig. 1 · The Scorecard" caption="Tesla's 1930 predictions sorted by what actually happened — the ones that became foundations, the ones that became niches, and the ones that did not survive contact with physics." alt="Comparison of Tesla's 1930 predictions with what actually happened" %}
