...
{% include figure.html src="/img/memory-cycle.svg" label="Fig. 1 · The Memory Cycle" caption="Attention, encoding, and retrieval are not three independent steps. Retrieval feeds back into attention, which feeds back into a stronger encoding. The cycle is the learning." alt="Memory cycle: attention, encoding, retrieval" %}
