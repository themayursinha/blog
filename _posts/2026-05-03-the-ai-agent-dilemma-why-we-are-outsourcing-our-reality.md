...
1. Read primary sources for high-stakes questions.
2. Ask agents to expose uncertainty, assumptions, and source conflicts.
3. Verify important claims outside the agent's own summary.
4. Keep manual drills for critical operational skills.
