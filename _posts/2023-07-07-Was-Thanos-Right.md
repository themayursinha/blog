...
{% include figure.html src="/img/thanos-thought-experiment.svg" label="Fig. 1 · The Thanos Thought Experiment" caption="Thanos identifies a real imbalance, then treats mass death as the only available lever." alt="Balance scale showing population outweighing resources, with the snap as a destructive intervention" %}
