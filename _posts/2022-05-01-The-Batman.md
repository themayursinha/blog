...
{% include figure.html src="/img/batman-visual-grammar.svg" label="Fig. 1 · Two Visual Grammars" caption="Nolan's deep focus (top) keeps the world sharp at every distance. Reeves and Fraser (bottom) blur everything except the protagonist." alt="Comparison of Nolan deep focus vs Reeves shallow focus visual grammar" %}
